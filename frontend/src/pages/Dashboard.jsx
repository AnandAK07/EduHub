                        ...
                        <header className="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
                            ...
                            <div className="flex items-center">
                                <div x-data="{ notificationOpen: false }" className="relative">
                                    ...
                                    <div x-show="notificationOpen" onClick="notificationOpen = false"
                                ...
                                <div x-data="{ dropdownOpen: false }" className="relative">
                                    ...
                                    <div x-show="dropdownOpen" onClick="dropdownOpen = false" className="fixed inset-0 z-10 w-full h-full"
